...
(function($ , undefined) {
	...
	Ace_File_Input.prototype.apply_settings = function() {
		...
		this.$element.after('<span class="ace-file-container my-ace-file-container" data-title="'+this.settings.btn_choose+'"><span class="ace-file-name" data-title="'+this.settings.no_file+'">'+(this.settings.no_icon ? '<i class="'+ ace.vars['icon'] + this.settings.no_icon+'"></i>' : '')+'</span></span>');
		...
		if(remove_btn) {
			var btn = 
			$('<a class="remove" style="top:4px;right:-28px" href="#"><i class="'+ ace.vars['icon'] + this.settings.icon_remove+'"></i></a>')
	...
	Ace_File_Input.prototype.reset_input_ui = function() {
		 this.$label.attr({'data-title':this.settings.btn_choose, 'class':'ace-file-container my-ace-file-container'})
	...
	///////////////////////////////////////////
	$.fn.myAceFileInput = $.fn.my_ace_file_input = function (option,value) {
		var retval;
	...
	$.fn.myAceFileInput.defaults = $.fn.my_ace_file_input.defaults = {
		style: false,
		no_file: 'No File ...',
