					...
					<ul class="nav ace-nav">
						...
						<li class="green">
							<a data-toggle="dropdown" class="dropdown-toggle" >
								...
								<span class="badge badge-success">{{unreadNoticeList.number}}</span>
							</a>

							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								<li class="dropdown-header">
									<i class="ace-icon fa fa-envelope-o"></i>
									{{unreadNoticeList.number}} Messages
								</li>

								<li class="dropdown-content">
									<ul class="dropdown-menu dropdown-navbar">
										<li v-for="nlist in unreadNoticeList.list_data" >
										<a v-link="'/mywork/notice/receive'" class="clearfix">
											<i class="ace-icon fa {{nlist | picFilter}} msg-photo" style="font-size:3em"></i>
												<!-- <img src="/static/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" /> -->
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">{{nlist.cuser_name}}:</span>
														{{nlist.notice_info}}	
													</span>

													<span class="msg-time">
														<i class="ace-icon fa fa-clock-o"></i>
														<span>{{nlist.ctime}}</span>
													</span>
												</span>
											</a>
										</li>
...
<script>
import {logout} from '../vuex/modules/authentication/LoginActions'

import {getNoticeUnreadList} from '../vuex/modules/notice/NoticeGetters'
import {reqNoticeUnreadList} from '../vuex/modules/notice/NoticeActions'
export default {
	vuex:{
		getters:{
			unreadNoticeList:getNoticeUnreadList
			//CT:getCodeTable
		},
		actions:{
			logout,
	...
	ready:function(){
		this.reqNoticeUnreadList();
	},
	init:function(){
		console.debug('navbar init');
		var self=this;
		this.timer=setInterval(function(){
			console.debug('navbar timer event debug');
			self.reqNoticeUnreadList(); 
		},50000);
	},
	destroyed:function(){
		console.debug('navbar destoryed');
