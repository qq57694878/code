...
<div>
	...
	<form class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<div class="input-group">
					<input class="form-control date-picker"  type="text" data-date-format="yyyy-mm-dd" v-model="task.form_data.actually_stime" name="actually_stime" v-validate:actually_stime="['required']">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<div class="input-group">
					<input class="form-control date-picker"  type="text" data-date-format="yyyy-mm-dd" v-model="task.form_data.actually_etime" name="actually_etime" v-validate:actually_etime="['required']">
					<span class="input-group-addon">
					<i class="fa fa-calendar bigger-110"></i>
					</span>
				</div>
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 工作量</label>
			<div class="col-sm-5">
				<input type="text"  placeholder="人/月" class="col-xs-10 col-sm-5" v-model="task.form_data.actually_work" name="actually_work" v-validate:actually_work="['required']">
			</div>
			<div class="help-block"> <span v-if="$validation.actually_work.required" style="color:#d16e6c">*必填</span> </div>
		</div>
				...
				if(result!=null) {
			 		let requestBody={ task_id:self.taskId,node_id:self.nodeId,task_type:self.taskType,instance_id:self.instanceId,
						form_data:{
							...
							actually_work:self.task.form_data.actually_work,
							opinion:result
						}};
