...
<div class="row">
	...
	<form class="form-horizontal" role="form" id="myform">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<!--
				<select class="form-control" name="business_app" >
				<option  v-for="app in businessApps | orderBy id"  value="{{app.id}}">{{app.name}}</option>
				</select>
				-->
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				...
				<div class="form-control" style="border:0">
						...
						<label>
						<input name="change_type" type="radio" class="ace" value="1" v-validate:change_type="['required']">
						...
						<div class="radio" style="display:inline">
						<label>
						<input name="change_type" type="radio" class="ace" value="2"  v-validate:change_type="['required']">
						...
						<div class="radio" style="display:inline">
						<label>
						<input name="change_type" type="radio" class="ace" value="3"  v-validate:change_type="['required']">
...
import {startRequirementChange } from '../../vuex/modules/task/TaskActions'
...
export default {
	...
	methods:{
		submit:function() {
			...
			// console.debug(this.$validation);
			// this.$validate(true,function(){
				// console.debug('validate done !!');
			// });
			...
			if(this.$validation.valid){
				...
				bootbox.confirm("您是否要提交?", function(result) {
					if(result) {
						...
						self.startRequirementChange(self,formData);
					}
				});
			}
