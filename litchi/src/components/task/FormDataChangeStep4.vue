...
<div>
	...
	<form class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<div class="input-group">
					<input class="form-control date-picker"  type="text" data-date-format="yyyy-mm-dd" v-model="task.form_data.actually_stime" name="actually_stime" v-model="task.form_data.actually_stime">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<div class="input-group">
					<input class="form-control date-picker"  type="text" data-date-format="yyyy-mm-dd" v-model="task.form_data.actually_etime" name="actually_etime" v-model="task.form_data.actually_etime">
					<span class="input-group-addon">
					<i class="fa fa-calendar bigger-110"></i>
					</span>
				</div>
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 执行SQL</label>
			<div class="col-sm-9">
				<textarea type="text" class="col-xs-10 col-sm-5" v-model="task.form_data.actually_sql" ></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 备份SQL</label>
			<div class="col-sm-9">
				<textarea type="text" class="col-xs-10 col-sm-5" v-model="task.form_data.backup_sql"></textarea>
			</div>
		</div>

		<div class="space-8"></div>
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right" for="form-field-1">处理方案</label>
			<div class="col-sm-9">
				...
				if(result!=null) {
			 		let requestBody={ task_id:self.taskId,node_id:self.nodeId,task_type:self.taskType,instance_id:self.instanceId,
						form_data:{
							...
							backup_sql:self.task.form_data.backup_sql,
							scheme:$('#htmleditor').summernote('code'),
							opinion:result
						}};
