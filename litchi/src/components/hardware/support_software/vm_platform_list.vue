...
<script>
  ...
  import {reqQueryInit} from '../../../vuex/modules/hardward/support_software/VmPlatActions';
  import {getInitList} from '../../../vuex/modules/hardward/support_software/VmPlatGetters';
  import {delInfo} from '../../../vuex/modules/hardward/support_software/VmPlatActions';
  ...
  export default {
    ...
    methods: {
      ...
      edit: function (id) {
        this.vmPlatReqFormInit(id);
        console.debug(id);
        $('#vm_plat a[href="#vm_plat1"]').tab('show');
