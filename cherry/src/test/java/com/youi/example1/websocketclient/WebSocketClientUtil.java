...
public class WebSocketClientUtil {
    ...
    public  void sendMessage(String url,Object message) throws Exception{
        this.sendMessage(url,message,new WebSocketHttpHeaders());
    }

    public  void sendMessage(String url,Object message,WebSocketHttpHeaders headers) throws Exception {
    ...
    public static void main(String[]args)throws Exception{
        ...
        p.put("key11","nihao");
        //WebSocketClientUtil.sendMessage("/app/send_host_items",new JSONObject(p));
    }
}
