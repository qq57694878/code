...
public class MyWebSocketClient3 {
    private static Logger logger = LoggerFactory.getLogger(MyWebSocketClient3.class);
    ...
    public void setup() {
        ...
        //配置心跳频率，默认就是下面这个间隔
        this.stompClient.setDefaultHeartbeat(new long[]{1000,1000});
    ...
    public  void sendMessage(final String sendUrl,final String subscribeUrl,Object message,WebSocketHttpHeaders headers) throws Exception {
        ...
        StompSessionHandler handler = new MyWebSocketClient3.TestSessionHandler(failure) {
        ...
        this.stompClient.connect(WEBSOCKET_URL, this.headers, handler);
