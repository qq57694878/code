...
@Component
public class MyWebSocketClient4 {
    private static Logger logger = LoggerFactory.getLogger(MyWebSocketClient4.class);
    ...
    public  void sendMessage(final String sendUrl,Object message,WebSocketHttpHeaders headers) throws Exception {
        ...
        StompSessionHandler handler = new MyWebSocketClient4.TestSessionHandler() {
        ...
        stompClient.setReceiptTimeLimit(500);
        //配置心跳频率，默认就是下面这个间隔
