...
@Entity
@Table(name="PM_PROCUREMENT_ATTACHMENT")
public class PM_PROCUREMENT_ATTACHMENT implements Serializable
{
	public PM_PROCUREMENT_ATTACHMENT(){}
	public PM_PROCUREMENT_ATTACHMENT(Long id, Long pid, Long attach_id, String attach_code){
		this.id = id;
		this.pid = pid;
