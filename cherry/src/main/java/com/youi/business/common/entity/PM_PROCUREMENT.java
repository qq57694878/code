...
@Entity
@Table(name="PM_PROCUREMENT")
public class PM_PROCUREMENT implements Serializable
{
	public PM_PROCUREMENT(){}
	public PM_PROCUREMENT(Long id, Long pid, String name, String budget_amount, String procurement_method, Long responsible_person, String bidding_company, Date bidding_hang_date, Date bidding_open_date, Date bidding_win_date, BigDecimal bid_amount, Date signup_end_date, Date contract_record_date, String bidding_win_company, Long bid_notification, String status, Long applicant, Date apply_date){
		this.id = id;
		this.pid = pid;
		this.name = name;
	...
	/**
	 *采购项目状态 0 未招标 1 招标中 2 已招标 3 签订合同
	 */
