...
public class IPv4Util {
    ...
    public static int getMaskInt( String mask) {
        int i = IPv4Util.ipToInt("255.255.255.255") - IPv4Util.ipToInt(mask);
     ...
     * @return String[]
     */
    public static String getMaskString( int mask) {
        int v =0xFFFFFFFF<<(32-mask);
       return IPv4Util.intToIp(v);
    }
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getMaskString(30));
      ...
      System.out.println(IPv4Util.getMaskInt("255.255.255.0"));
       // test1();
    }
    ...
    public static void test1(){
        ...
        for( int i=ipscope[0];i<=ipscope[1];i++){
            System.out.println(IPv4Util.intToIp(i));
        }
    }
}