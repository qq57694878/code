...
@Entity
@Table(name="SW_DATA_CHANGE")
public class SW_DATA_CHANGE implements Serializable
{
	public SW_DATA_CHANGE(){}
	public SW_DATA_CHANGE(Long id,String instanceid,String userid,Date cdate,Long c_org_id,String title,String description,Date stime,Date etime,Long business_app,Long company_id,Long leader_id,Date actually_stime,Date actually_etime,String backup_sql,String actually_sql,String scheme,String biz_ext,String act_ext){
		this.id = id;
	...
	public void setBackup_sql(String backup_sql)
	{
		this.backup_sql = backup_sql;
	}

	@Column(name = "BACKUP_SQL")
	public String getBackup_sql()
	{
		return backup_sql;
	}
