 ...
 */
@Component
public class MyWebSocketSubscriptWaterItemsHandler extends TextWebSocketHandler {

    private static Logger logger = LoggerFactory.getLogger(MyWebSocketSubscriptWaterItemsHandler.class);
