 ...
 */
@Component
public class MyWebSocketSubscriptVmItemsHandler extends TextWebSocketHandler {

    private static Logger logger = LoggerFactory.getLogger(MyWebSocketSubscriptVmItemsHandler.class);
