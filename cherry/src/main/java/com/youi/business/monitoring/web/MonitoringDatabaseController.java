...
import com.youi.business.monitoring.service.MonitoringDatabaseService;
 ...
 */
@RestController
public class MonitoringDatabaseController {
    @Autowired
    private MonitoringDatabaseService monitoringDatabaseService;
    @Autowired
    ...
    public RestResult getDatabaseMonitoringList(@Userid Long userid,@RequestBody(required = false) Map<String,String>param) throws Exception {
        param.put("userid",String.valueOf(userid));
        Map<String,Object> r= monitoringDatabaseService.getDatabaseMonitoringList(param);
