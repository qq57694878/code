 ...
 */
@Component
public class MyWebSocketSubscriptHostItemsHandler extends TextWebSocketHandler {

    private static Logger logger = LoggerFactory.getLogger(MyWebSocketSubscriptHostItemsHandler.class);
