...
import com.youi.core.id.IdGenerator;
import com.youi.core.page.Page;
import com.youi.core.query.MatchType;
import com.youi.core.query.PropertyFilter;
import com.youi.core.util.GenericsUtils;
...
public class HibernateEntityDao<T> extends HibernatePagingDao {
    ...
    // ~ ======================================================================
    // sql
    public Page pagedSQLQuery(String sql, Page page,
                           List<PropertyFilter> propertyFilters) {
        ...
        if (page.isOrderEnabled()) {
            ...
            for (int i = 0; i < page.getOrderBys().size(); i++) {
                ...
                if ("ASC".equals(page.getOrders().get(i))) {
                    buff.append(orderBy).append(" ASC");
                } else {
                    buff.append(orderBy).append(" DESC");
                }
            }
        }
        return pagedSQLQuery(buff.toString(), page.getPageNo(), page.getPageSize(), map);
    }
