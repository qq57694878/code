...
public class HibernatePagingDao extends HibernateGenericDao {
    ...
    public Page pagedSQLQuery(String sql, int pageNo, int pageSize,
        ...
        String countQueryString = "select count(*) "
                + HibernateUtils.removeSelect(HibernateUtils.removeOrders(sql));
        Integer totalCount = this.getSQLCount(countQueryString, values);
    ...
    public Page pagedSQLQuery(String sql, int pageNo, int pageSize,
        ...
        String countQueryString = "select count(*) "
                + HibernateUtils.removeSelect(HibernateUtils.removeOrders(sql));
        Integer totalCount = this.getSQLCount(countQueryString, map);
