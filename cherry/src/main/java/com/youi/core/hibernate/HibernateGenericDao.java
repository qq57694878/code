package com.youi.core.hibernate;

import com.youi.core.query.PropertyFilter;
import com.youi.core.util.BeanUtils;
import com.youi.core.util.ReflectUtils;
...
public class HibernateGenericDao extends HibernateBasicDao {
    ...
    public SQLQuery createSQLQuery(String sql, Object... values) {
        Assert.hasText(sql, "sql cannot be null");
        ...
        query.setResultTransformer(new ResultTransformer() {
            ...
            public Object transformTuple(Object[] tuple, String[] aliases) {
                if(tuple!=null&&tuple.length==1&&tuple[0] instanceof Number) {return tuple[0];};
    ...
    public SQLQuery createSQLQuery(String sql, List<PropertyFilter> propertyFilters,String orderby) {
        ...
        return createSQLQuery(buff.toString(),map);
    }
    ...
    public Integer getSQLCount(String sql, Object... values) {
        Object result = createSQLQuery(sql, values).uniqueResult();
     ...
     */
    @Transactional(readOnly = true)
    public Integer getSQLCount(String sql, Map<String, Object> map) {
        Object result = createSQLQuery(sql, map).uniqueResult();
